...
/**    回调当前值     */
@property (nonatomic,copy)   NSString *             (^rulerDidEndScrollingBlock)(CGFloat value);
@property (nonatomic,copy)   NSString *             (^rulerDidScrollBlock)(CGFloat value, CGPoint rulerContentOffset);



/**    自定义刻度相关     */
@property (nonatomic,assign) NSInteger              scalesCount;
@property (nonatomic,assign) CGFloat                defaultScale;
@property (nonatomic,copy)   NSString             * (^rulerScaleTextFormatBlock)(CGFloat currentCalibrationIndex);
@property (nonatomic,copy)   NSString             * (^rulerScaleDidEndScrollingBlock)(CGFloat index);
@property (nonatomic,copy)   NSString             * (^rulerScaleDidScrollBlock)(CGFloat index);
